...
class GPACivilSem08 extends StatefulWidget {
  @override
  _GPACivilSem08State createState() => _GPACivilSem08State();
}

class _GPACivilSem08State extends State<GPACivilSem08> {
  double em3 = 0.0,
      elec = 0.0,
      thermo = 0.0,
      co = 0.0,
  ...
  Widget selectMod1() {
    return Container(
      child: DropdownButton<String>(
        ...
        items: <String>[
          'Select Module',
          'CE4353 Advanced Structural Analysis & Design II',
          'CE4254 Building Services',
          'CE4355 Construction Technology',
          'CE4361 Water & Wastewater Engineering',
          'CE4363 Limnology',
          'CE4365 Environmental Management',
          'CE4371 Highwaye Engineering Design',
          'CE4373 Traffic Management & Saftey',
          'CE4264 Environmental Impact Assesment',
          'CE4374 Air & Water Transport Systems',
          'CE4374 Sustainable Design & Construction'
        ].map<DropdownMenuItem<String>>((String e) {
          return DropdownMenuItem<String>(
            value: e,
            child: Text(e),
  ...
  int modCredits(String s) {
    if (s == "CE4353 Advanced Structural Analysis & Design II")
      return 3;
    else if (s == "CE4254 Building Services")
      return 3;
    else if (s == "CE4355 Construction Technology")
      return 3;
    else if (s == "CE4361 Water & Wastewater Engineering")
      return 3;
    else if (s == "CE4363 Limnology")
      return 3;
    else if (s == "CE4365 Environmental Management")
      return 3;
    else
      return 0;
  }
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                Text(
                  "\nCE4603 Research Project - " + ce.toStringAsFixed(3),
              ...
              child: Column(
                children: [
                  TextButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        em3 = mo4 * updateGradeOne(m);
                        meas = updateGradeOne(mm);
                        total = (elec + thermo + co + meas + ce + me + em3);
                      });
                    },
                    child: Text(
                      "CALCULATE",
                  ...
                  FloatingActionButton(
                    ...
                    onPressed: () {
                      globals.sem08Credits = 6 + mo1 + mo2 + mo3 + mo4;
