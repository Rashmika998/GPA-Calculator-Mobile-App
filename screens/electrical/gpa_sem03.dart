...
class GPAElecSem03 extends StatefulWidget {
  @override
  _GPAElecSem03State createState() => _GPAElecSem03State();
}

class _GPAElecSem03State extends State<GPAElecSem03> {
  double em3 = 0.0,
      elec = 0.0,
      thermo = 0.0,
      co = 0.0,
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                Text(
                  "\nEE2201 Power Systems I - " + ce.toStringAsFixed(3),
            ...
            Column(
              children: [
                Text(
                  "\n[optional]CO2203 Object Oriented Programming - " +
            ...
            Column(
              children: [
                Text(
                  "\nEE2203 Machines and Drives I - " + me.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            Column(
              children: [
                Text(
                  "\nEE2305 Analog Electronics - " + thermo.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            Container(
              ...
              child: Column(
                children: [
                  TextButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        elec = updateGrade(ee);
                        me = updateGrade(mech);
                        thermo = updateGradeThree(th);
                        em3 = updateGradeThree(m);
                        meas = updateGrade(mm);
                        eng = updateGrade(en);
                        his = updateGrade(hist);
                        total_sem03 =
                            ((em3 + thermo + co + ce + me + meas + eng + his));
                      });
                    },
                    child: Text(
                      "CALCULATE",
                  ...
                  Text(
                    "\nTotal GPA: " + total_sem03.toStringAsFixed(3),
                    style: TextStyle(
                      fontSize: 25.0,
