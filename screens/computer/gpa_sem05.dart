...
class GPAComSem05 extends StatefulWidget {
  @override
  _GPAComSem05State createState() => _GPAComSem05State();
}

class _GPAComSem05State extends State<GPAComSem05> {
  double em3 = 0.0,
      elec = 0.0,
      thermo = 0.0,
      co = 0.0,
  ...
  Widget selectMod1() {
    return Container(
      child: DropdownButton<String>(
        ...
        items: <String>[
          'Select Module',
          'CO3302 Computer Security',
          'CO3251 Natural Language Processing',
          'CO3252 Management Information Systems',
          'CO3353 Data Mining',
          'CO3261 Cloud Computing and Appplications',
          'CO3262 Advanced Computer Architecture'
        ].map<DropdownMenuItem<String>>((String e) {
          return DropdownMenuItem<String>(
            value: e,
            child: Text(e),
  ...
  int modCredits(String s) {
    if (s == "CO3302 Computer Security")
      return 2;
    else if (s == "CO3251 Natural Language Processing")
      return 2;
    else if (s == "Management Information System")
      return 2;
    else if (s == "CO3353 Data Mining")
      return 3;
    else if (s == "CO3261 Cloud Computing and Appplications")
      return 2;
    else if (s == "CO3262 Advanced Computer Architecture")
      return 2;
    else
      return 0;
  }
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                Text(
                  "\nCO3201 Database Systems - " + ce.toStringAsFixed(3),
            ...
            Column(
              children: [
                Text(
                  "\nIS3202 Discrete Mathematics V - " + em3.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            Container(
              ...
              child: Column(
                children: [
                  TextButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        total = ((em3 + elec + thermo + co + ce + me));
                      });
                    },
                    child: Text(
                      "CALCULATE",
                  ...
                  Text(
                    "\nTotal GPA: " +
                        (total / (8 + mo1 + mo2 + mo3)).toStringAsFixed(3),
                    style: TextStyle(
                      fontSize: 25.0,
                  ...
                  FloatingActionButton(
                    ...
                    onPressed: () {
                      globals.sem05Credits = 8 + mo1 + mo2 + mo3;
