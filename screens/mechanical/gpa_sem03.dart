...
class GPAMechSem03 extends StatefulWidget {
  @override
  _GPAMechSem03State createState() => _GPAMechSem03State();
}

class _GPAMechSem03State extends State<GPAMechSem03> {
  double em3 = 0.0,
      elec = 0.0,
      thermo = 0.0,
      co = 0.0,
        ...
        child: Column(
          ...
          children: [
            Column(
              children: [
                Text(
                  "\nME2301 Theory of Machines - " + ce.toStringAsFixed(3),
            ...
            Column(
              children: [
                Text(
                  "\nME2302 Fluid Dynamics - " + co.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            Column(
              children: [
                Text(
                  "\nME2303 Applied Thermodynamics I - " +
            ...
            Column(
              children: [
                Text(
                  "\nME2104 Sensors and Actuators - " + me.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
            ...
            Column(
              children: [
                Text(
                  "\nEE2191 Electrical Machines - " + thermo.toStringAsFixed(3),
                  style: TextStyle(fontSize: 17),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        me = updateGradeOne(mech);
                        thermo = updateGradeOne(th);
                        em3 = updateGradeThree(m);
                        meas = updateGrade(mm);
                        eng = updateGrade(en);
                        total_sem03 =
                            ((em3 + thermo + elec + co + ce + me + meas + eng));
                      });
                    },
                    child: Text(
                      "CALCULATE",
